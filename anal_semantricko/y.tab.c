...
{
       0,   204,   204,   208,   213,   235,   240,   241,   243,   255,
     256,   258,   260,   261,   263,   272,   273,   275,   276,   278,
     312,   330,   345,   346,   348,   350,   352,   354,   368,   369,
     371,   372,   374,   375,   377,   378,   379,   380,   382,   383,
     385,   445,   456,   509,   513,   519,   527,   529,   538,   582,
     607,   619,   629,   639,   649,   659,   671,   681,   691,   703,
     754,   755,   757,   759,   760,   796,   847,   852,   854,   859,
     861,   873,   884,   895,   906,   917,   929,   935,   942,   950,
     960,   973
};
#endif
                ...
                if (ambito == 0){
                  ...
                  if (simbol == NULL){                        // Si se busca en global pero no lo encuentra
                    ...
                    if((yyvsp[0].atributos).es_direccion){
                      printf("\nTRICK 1: before asignar: %s = %s", (yyvsp[-2].atributos).lexema, (yyvsp[0].atributos).lexema);
                    }
                    else{
                      printf("\nTRICK 1: before asignar: %s = %d", (yyvsp[-2].atributos).lexema, (yyvsp[0].atributos).valor_entero);
                    }
...
#line 457 "alfa.y" /* yacc.c:1646  */
    {
                    ...
                    escribir_operando(yyout,(yyvsp[-1].atributos).lexema,(yyvsp[-1].atributos).es_direccion);
...
#line 582 "alfa.y" /* yacc.c:1646  */
    {
                             // fons1 escribir(yyout, $2.es_direccion, $2.tipo);
                              ...
                              if((yyvsp[0].atributos).es_direccion){
                                ...
                                escribir(yyout, CTE, (yyvsp[0].atributos).tipo);
                              }
...
#line 862 "alfa.y" /* yacc.c:1646  */
    {
              ...
              funcOp(yyout, (yyvsp[-2].atributos), (yyvsp[0].atributos), CMP_IGUAL);
...
#line 874 "alfa.y" /* yacc.c:1646  */
    {
              ...
              (yyval.atributos).tipo = BOOLEAN;
              (yyval.atributos).es_direccion = 0;
              funcOp(yyout, (yyvsp[-2].atributos), (yyvsp[0].atributos), CMP_DIST);
...
#line 885 "alfa.y" /* yacc.c:1646  */
    {
              ...
              (yyval.atributos).tipo = BOOLEAN;
              (yyval.atributos).es_direccion = 0;
              funcOp(yyout, (yyvsp[-2].atributos), (yyvsp[0].atributos), CMP_MEN_IG);
...
#line 896 "alfa.y" /* yacc.c:1646  */
    {
              ...
              (yyval.atributos).tipo = BOOLEAN;
              (yyval.atributos).es_direccion = 0;
              funcOp(yyout, (yyvsp[-2].atributos), (yyvsp[0].atributos), CMP_MAY_IG);
...
#line 907 "alfa.y" /* yacc.c:1646  */
    {
              ...
              (yyval.atributos).tipo = BOOLEAN;
              (yyval.atributos).es_direccion = 0;
              funcOp(yyout, (yyvsp[-2].atributos), (yyvsp[0].atributos), CMP_MEN);
...
#line 918 "alfa.y" /* yacc.c:1646  */
    {
              ...
              (yyval.atributos).tipo = BOOLEAN;
              (yyval.atributos).es_direccion = 0;
              funcOp(yyout, (yyvsp[-2].atributos), (yyvsp[0].atributos), CMP_MAY);
