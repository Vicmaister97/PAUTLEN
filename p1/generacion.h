...
etiqueta deben ejecutarse antes las tareas correspondientes a esta situación
exp_es_variable
   Es 1 si la expresión de la condición es algo asimilable a una variable (identificadorelemento de vector)
   Es 0 en caso contrario (constante u otro tipo de expresión)
*/
...
exp_es_variable
   Es 1 si la expresión de la condición es algo asimilable a una variable (identificadoro elemento de vector)
   Es 0 en caso contrario (constante u otro tipo de expresión)
*/
